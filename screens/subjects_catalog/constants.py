...
# This list is for a full data dump (export), so it keeps internal names
# and all fields, including the ones hidden from the UI.
...
# --- *** MODIFIED SECTION (PER USER REQUEST) *** ---
# This list defines the columns for the IMPORT TEMPLATE.
# It now uses the user-friendly labels and removes the threshold fields.
