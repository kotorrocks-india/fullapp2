"""
Import/Export Tab - Download and upload catalog data
Handles subjects catalog and syllabus templates only.
For subject offerings import/export, see subject_offerings module.
"""
...
from ..templates_import import import_templates_from_df, TEMPLATE_IMPORT_COLUMNS
...
def render(engine, actor: str, CAN_EDIT: bool):
    ...
    # =========================
    # EXPORT SUBJECTS CATALOG
    # =========================
    with col1:
        st.markdown("### Export Subjects Catalog")
        st.caption("Export master subject definitions (time-independent)")
    ...
    # =========================
    with col2:
        st.markdown("### Export Syllabus Templates")
        st.caption("Export reusable syllabus structures")
